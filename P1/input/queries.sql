...
SELECT * FROM Sailors WHERE Sailors.A = 50;
SELECT * FROM Sailors WHERE Sailors.A < 50;
SELECT * FROM Sailors WHERE Sailors.A < 50 AND Sailors.A > 40;
SELECT * FROM Sailors WHERE Sailors.A < 50 AND Sailors.A > 40 AND Sailors.A < 48;
SELECT * FROM Sailors WHERE Sailors.A < 50 AND Sailors.B > 40 AND Sailors.A < 48;