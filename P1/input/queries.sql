...
SELECT Boats.F, Boats.D, Reserves.G, Sailors.A FROM Boats, Reserves,Sailors;
SELECT Boats.F, Boats.D, Reserves.G, Sailors.A FROM Sailors, Reserves,Boats WHERE Sailors.A = Reserves.G AND Reserves.H = Boats.D;
SELECT * FROM Sailors , Reserves, Boats WHERE Sailors.A = Reserves.G AND Reserves.H = Boats.D ORDER BY S.C;
