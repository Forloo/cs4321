...
-- SELECT * FROM Sailors S, Reserves R, Boats B WHERE S.A<100 AND S.A=S.B;
...
-- SELECT * FROM Sailors, Reserves, Boats, Pictures WHERE Sailors.A<100 AND Sailors.A=Sailors.B AND Sailors.B=Boats.D AND Boats.D>50 AND Boats.E=42 AND Boats.E=Reserves.G AND Sailors.C=Pictures.I;
