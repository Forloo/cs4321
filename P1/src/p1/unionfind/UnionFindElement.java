...
public class UnionFindElement {
	...
	// 3. We need something that tells us the attributes that are in the current union find element
	// 4. We need something to tell us if the condition is an equality meaning that everything is constrained.
