...
public class BNLJOperator extends Operator {
	...
	// Keep track of where we are in the tuple for the left table of the joined
	// column
	private Tuple currTuple;
	// The current right tuple value
	private Tuple rightTuple;
	// A string denoting the list of tables that we need for executing the given
	// join
	 ...
	 * 
	 * @param tables     The string delimited by commas that provided the tables
	 *                   needed for the join
	 * @param left       The left child of the bnlj
	 * @param right      The right child of the bnlj
	 * @param exp        The list of expressions imposed on the result tuples of the
	 *                   bnlj
	 * @param bufferSize The number of pages that will be used for the outer loops
	 *                   blocks
	 */
