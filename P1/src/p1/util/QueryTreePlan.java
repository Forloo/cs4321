...
public class QueryTreePlan {
	...
	/**
	 * Constructor for the queryplan tree built using the query and the
	 * databasecatalog.
	 *
	 * @param query
	 * @param db
	...
	public QueryTreePlan(Statement query, DatabaseCatalog db) {
		// Dp this later the important part will be translating the code from the nodes
		// to this structure
	...
	/**
	 * Constructor for the queryplan tree built using the visitor plan from the
	 * logical plan.
	 *
	 * @param treeInput A tree that will become the tree for our query plan.
	 */
	public QueryTreePlan(QueryTree treeInput) {
		// After using the visitor pattern to build up the tree we can just set it as
		// our tree after
