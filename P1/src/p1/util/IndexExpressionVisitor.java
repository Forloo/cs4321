...
public class IndexExpressionVisitor implements ExpressionVisitor {
	 ...
	 */
	public IndexExpressionVisitor(String col) {
		column = col;
		lowkey = Integer.MAX_VALUE;
		highkey = Integer.MIN_VALUE;
	}
	...
	/**
	 * Evaluates the low/high key of the left and right expression
	 *
	...
	private String[] leftRightVals(BinaryExpression arg0) {
		...
		IndexExpressionVisitor leftEval;
		IndexExpressionVisitor rightEval;
		leftEval = new IndexExpressionVisitor(column);
		rightEval = new IndexExpressionVisitor(column);
		left.accept(leftEval);
		right.accept(rightEval);
		int leftHigh = leftEval.getHigh();
		int leftLow = leftEval.getLow();
		int rightHigh = rightEval.getHigh();
		int rightLow = rightEval.getLow();
